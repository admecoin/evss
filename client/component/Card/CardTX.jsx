...
export default class CardTX extends Component {
  ...
  render() {
	...
	/*
	if(this.state.tx.vin && this.props.tx.vin.length) {
		this.props.tx.vin.forEach(vin => blockValue -= vin.value);	
	}
	*/
    ...
    return (
      ...
      <div className="card--block">
        ...
        <div className="card__row">
          ...
          <span className="card__result">{ numeral(blockValue).format('0,0.0000') } EVOS</span>
        </div>
        <div className="card__row">
