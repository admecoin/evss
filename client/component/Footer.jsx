    ...
    return (
      <div className="footer">
        <div className="footer__block">
          <img className="footer__logo" src="/img/logofooter.png" />
          <span className="footer__legal">
            <div>Copyright &copy; 2018 <a href="https://evos.one/">EVOS</a></div>
            <div>Site design / Logo &copy; 2018 <a href="https://evos.one/">EVOS</a></div>
          </span>
        </div>
        <div className="footer__block">
